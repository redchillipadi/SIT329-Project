...
COMPILE: ADC_HAL.srec

ADC_HAL.srec: ADC_HAL.elf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

GENERATE_BSP: BSP/setting.bsp

ADC_HAL.elf: makefile BSP/setting.bsp
	make
...
makefile: 
	nios2-app-generate-makefile.exe --bsp-dir BSP/ --set OBJDUMP_INCLUDE_SOURCE 1 --set APP_CFLAGS_OPTIMIZATION -O1 --elf-name "ADC_HAL.elf" --src-files "ADC_HAL.c"
