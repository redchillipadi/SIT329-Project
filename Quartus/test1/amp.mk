...
makefile: 
	nios2-app-generate-makefile --bsp-dir BSP/ --set OBJDUMP_INCLUDE_SOURCE 1 --set APP_CFLAGS_OPTIMIZATION -O1 --elf-name "getting_started.elf" --src-files "getting_started.c"
