...
# Memory: Nios2_2nd_Core_SRAM
MEM_1 := Computer_System_Nios2_2nd_Core_SRAM
$(MEM_1)_NAME := Nios2_2nd_Core_SRAM
...
$(MEM_1)_HIERARCHICAL_PATH := Nios2_2nd_Core_SRAM
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: Nios2_2nd_Core_SRAM
Nios2_2nd_Core_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: Nios2_SRAM
MEM_2 := Computer_System_Nios2_SRAM
$(MEM_2)_NAME := Nios2_SRAM
...
$(MEM_2)_END := 0x00007fff
$(MEM_2)_SPAN := 0x00008000
$(MEM_2)_HIERARCHICAL_PATH := Nios2_SRAM
$(MEM_2)_WIDTH := 32
...
.PHONY: Nios2_SRAM
Nios2_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: Onchip_SRAM
MEM_3 := Computer_System_Onchip_SRAM
$(MEM_3)_NAME := Onchip_SRAM
...
$(MEM_3)_END := 0x0803ffff
$(MEM_3)_SPAN := 0x00040000
$(MEM_3)_HIERARCHICAL_PATH := Onchip_SRAM
$(MEM_3)_WIDTH := 32
...
.PHONY: Onchip_SRAM
Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
MEM_4 := Computer_System_VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
$(MEM_4)_NAME := VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
...
$(MEM_4)_START := 0x09000000
$(MEM_4)_END := 0x09001fff
$(MEM_4)_SPAN := 0x00002000
$(MEM_4)_HIERARCHICAL_PATH := VGA_Subsystem.Char_Buf_Subsystem.Onchip_SRAM
$(MEM_4)_WIDTH := 32
...
VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym
