...
# Flags
SYS_FLAG_CABLE			:= -c "DE-SoC [1-4]"
SYS_FLAG_USB			:= "1-4"
SYS_FLAG_JTAG_INST		:= --instance
SYS_FLAG_NII_HALT		:= --stop

# Files
SYS_FILE_SOF			:= "/home/adrian/Documents/SIT329-Project/Quartus/adc_demo/output_files/adc_demo.sof"
...
COMPILE: adc_hps.srec

adc_hps.srec: adc_hps.elf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@
...
CLEAN: 
	$(RM) adc_hps.srec adc_hps.elf $(OBJS)
