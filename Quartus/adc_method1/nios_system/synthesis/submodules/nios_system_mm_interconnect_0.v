...
module nios_system_mm_interconnect_0 (
		input  wire        clk_0_sys_clk_clk,                     //                   clk_0_sys_clk.clk
	...
	wire  [88:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [88:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [88:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [88:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [88:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_003:sink0_data
	...
	wire  [88:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> rsp_mux_001:sink1_data
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_sys_clk_clk),                        // in_clk_0.clk
